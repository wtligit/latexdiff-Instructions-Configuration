...
当然也可以在 https://www.ctan.org/tex-archive/support/latexdiff 网站下载latexdiff前缀的文件放到Perl中,或者在我的Github里直接下载![perl](https://github.com/wtligit/latexdiff-Instructions-Configuration/tree/master/perl)。
